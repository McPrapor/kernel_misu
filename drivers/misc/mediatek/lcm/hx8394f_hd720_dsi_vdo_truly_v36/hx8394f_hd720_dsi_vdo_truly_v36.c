...
//#define GPIO_65132_ENN  PINMUX_GPIO83__FUNC_GPIO83
//#define GPIO_65132_ENP  PINMUX_GPIO86__FUNC_GPIO86
//#define GPIO146         PINMUX_GPIO146__FUNC_GPIO146
//#define GPIO_65132_ENN  MTK_GET_PIN_NO(83)
//#define GPIO_65132_ENP  MTK_GET_PIN_NO(86)
//#define GPIO146         MTK_GET_PIN_NO(146)
//#define GPIO_65132_ENN  (GPIO83 | 0x80000000)
//#define GPIO_65132_ENP  (GPIO86 | 0x80000000)
//#define GPIO146         146
...
//    int lcm_adc = 0, data[4] = {0,0,0,0};		
    ...
    lcm_debug("[HX8394F] hx8394f_hd720_dsi_vdo_truly %s %d\n", __func__,__LINE__);
...
#else
    printk("[HX8394F] %s, hx8394f_hd720_dsi_vdoid1 id1 = 0x%08x\n", __func__, id1);
    printk("[HX8394F] %s, hx8394f_hd720_dsi_vdoid1 id2 = 0x%08x\n", __func__, id2);
#endif
...
int TPS65132_WRITE_byte(kal_uint8 addr, kal_uint8 value)
{
    ...
    printf("[HX8394F] %s: i2c_write: ret_code: %d\n", __func__, ret_code);
...
#endif
    if(ret<0)
        printk("[KERNEL] [HX8394F] TM050-----tps6132---cmd=%0x-- i2c write error-----\n",cmd);
    else
        printk("[KERNEL] [HX8394F] TM050-----tps6132---cmd=%0x-- i2c write success-----\n",cmd);
#endif
...
static void lcm_init_power(void)
{
	...
	printf("%s, end\n", __func__);
#else
	printk("[HX8394F] %s, begin\n", __func__);
	pmic_set_register_value(PMIC_RG_VGP1_VOSEL,3);
	pmic_set_register_value(PMIC_RG_VGP1_EN,1);
	MDELAY(50);
	printk("[HX8394F] %s, end\n", __func__);
#endif
#endif
}
