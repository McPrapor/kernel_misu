...
#include "s5k3l2xxv36mipiraw_Sensor.h"
...
{{ 4192, 3104, 0000, 0000, 4192, 3104, 2096, 1552, 0000, 0000, 2096, 1552, 000, 0000, 2096, 1552}, // Preview
 ...
 { 4208, 3120,  186,  480, 3840, 2159, 1280,  720, 0000, 0000, 1280,  720, 000, 0000, 1280,  720}, //hight speed video
...
static void set_shutter(kal_uint32 s_shutter)
{
	...
	#define SHUTTER_FRAMELENGTH_MARGIN 16
		...
		if(s_shutter + SHUTTER_FRAMELENGTH_MARGIN > imgsensor_info.max_frame_length){
			LOG_INF("long exposure --\n");
			frame_length = imgsensor_info.max_frame_length;
			adjusted_line_length_pclk = (s_shutter + SHUTTER_FRAMELENGTH_MARGIN) * imgsensor.line_length / imgsensor_info.max_frame_length;
			shutter = frame_length - SHUTTER_FRAMELENGTH_MARGIN;
		}
		else{
			LOG_INF("normal exposure --\n");
			frame_length = s_shutter + SHUTTER_FRAMELENGTH_MARGIN; 
		...
		//HTC_START, manual shutter mode
		if (adjusted_line_length_pclk > 0){
			LOG_INF("line length adjust to %d\n", adjusted_line_length_pclk);
			line_length_pclk = adjusted_line_length_pclk;
		}
		else if (pre_line_length_pclk > 0){
			LOG_INF("line length recover to %d\n", imgsensor.line_length);
			line_length_pclk = imgsensor.line_length;  //original setting for this mode
		}
		else{
			line_length_pclk = 0; //skip setting
		}

		//HTC_END, manual shutter mode

		if(imgsensor.autoflicker_en == KAL_TRUE && !adjusted_line_length_pclk)
		{
		...
		if (line_length_pclk > 0)
		{
			...
			//write_cmos_sensor1(0x3382, line_length_pclk);
			write_cmos_sensor1(0x0200, line_length_pclk);
			write_cmos_sensor1(0x0342, line_length_pclk);
		}
...
static void hs_video_setting(void)
{
	...
	mDELAY(10);
	//ExtcClk	              24	MHz
	//VT picxel clk	        432	MHz
	//OP system clk	        648	MHz
	//IM_Width	            3840	px
	//IM_Height	            2159	px
	//Width	                1280	px
	//Height	              720	px
	...
	write_cmos_sensor1(0x0200,0x000A);   //fine_integration_time
	write_cmos_sensor1(0x0202,0x0014);   //coarwrite_cmos_sensor1(0xe_integratino_time
	write_cmos_sensor1(0x0136,0x1800);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_op_cond_extclk_frequency_mhz
	write_cmos_sensor1(0x0304,0x0006);      //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_clockwrite_cmos_sensor1(0x_pre_pll_clk_div
	write_cmos_sensor1(0x0306,0x00D8);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_clockwrite_cmos_sensor1(0x_pll_multiplier
	write_cmos_sensor1(0x030C,0x0006);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_clockwrite_cmos_sensor1(0x_write_cmos_sensor1(0xecnd_pre_pll_clk_div
	write_cmos_sensor1(0x030E,0x00A2);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_clockwrite_cmos_sensor1(0x_write_cmos_sensor1(0xecnd_pll_multiplier
	write_cmos_sensor1(0x0302,0x0001);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_clockwrite_cmos_sensor1(0x_vt_write_cmos_sensor1(0xywrite_cmos_sensor1(0x_clk_div
	write_cmos_sensor1(0x0300,0x0002);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_clockwrite_cmos_sensor1(0x_vt_pix_clk_div
	write_cmos_sensor1(0x030A,0x0001);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_clockwrite_cmos_sensor1(0x_op_write_cmos_sensor1(0xywrite_cmos_sensor1(0x_clk_div
	write_cmos_sensor1(0x0308,0x0008);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_clockwrite_cmos_sensor1(0x_op_pix_clk_div
	write_cmos_sensor(0x304F,0x00);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_vendor_mipi_uwrite_cmos_sensor1(0xe_extra_packetwrite_cmos_sensor1(0x
	write_cmos_sensor(0x35D9,0x03);   //write_cmos_sensor1(0xenAnalog_AIG_Firwrite_cmos_sensor1(0xtwrite_cmos_sensor1(0xcanConfiguration
	write_cmos_sensor(0x303A,0x02BC);
	write_cmos_sensor(0x0B05,0x01);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_iwrite_cmos_sensor1(0xp_mapped_couplet_correct_enable
	write_cmos_sensor(0x0B08,0x01);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_iwrite_cmos_sensor1(0xp_dynamic_couplet_correct_enable
	write_cmos_sensor(0x380E,0x01);   //giwrite_cmos_sensor1(0xp_offwrite_cmos_sensor1(0x_gainwrite_cmos_sensor1(0x_Ofwrite_cmos_sensor1(0xGainVecwrite_cmos_sensor1(0xelect
	write_cmos_sensor(0x3027,0x10);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_vendor_write_cmos_sensor1(0xenwrite_cmos_sensor1(0xor_dig_hor_bin_write_cmos_sensor1(0xcale_fact
	write_cmos_sensor1(0x0342,0x1190);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_frame_timing_line_length_pck
	write_cmos_sensor1(0x0340,0x0640);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_frame_timing_frame_length_linewrite_cmos_sensor1(0x
	write_cmos_sensor1(0x034C,0x0500);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_frame_timing_x_output_write_cmos_sensor1(0xize
	write_cmos_sensor1(0x034E,0x02D0);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_frame_timing_y_output_write_cmos_sensor1(0xize
	write_cmos_sensor(0x0114,0x03);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_output_lane_mode
	write_cmos_sensor1(0x0344,0x00BA);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_frame_timing_x_addr_write_cmos_sensor1(0xtart
	write_cmos_sensor1(0x0346,0x01E0);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_frame_timing_y_addr_write_cmos_sensor1(0xtart
	write_cmos_sensor1(0x0348,0x0FB9);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_frame_timing_x_addr_end
	write_cmos_sensor1(0x034A,0x0A4E);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_frame_timing_y_addr_end
	write_cmos_sensor1(0x3010,0x0000);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_vendor_write_cmos_sensor1(0xenwrite_cmos_sensor1(0xor_offwrite_cmos_sensor1(0xet_x
	write_cmos_sensor1(0x3012,0x0000);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_vendor_write_cmos_sensor1(0xenwrite_cmos_sensor1(0xor_offwrite_cmos_sensor1(0xet_y
	write_cmos_sensor1(0x0386,0x0005);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_write_cmos_sensor1(0xub_write_cmos_sensor1(0xample_y_odd_inc
	write_cmos_sensor1(0x0382,0x0001);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_write_cmos_sensor1(0xub_write_cmos_sensor1(0xample_x_odd_inc
	write_cmos_sensor(0x0900,0x01);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_binning_mode
	write_cmos_sensor(0x0901,0x13);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_binning_type
	write_cmos_sensor(0x3027,0x30);   //vendor_write_cmos_sensor1(0xenwrite_cmos_sensor1(0xor_dig_hor_bin_write_cmos_sensor1(0xcale_factor
	write_cmos_sensor(0x3BCE,0x30);   //giwrite_cmos_sensor1(0xp_hvbin_Weightwrite_cmos_sensor1(0x_2__0_
	write_cmos_sensor(0x3BCF,0x10);   //giwrite_cmos_sensor1(0xp_hvbin_Weightwrite_cmos_sensor1(0x_2__1_
	write_cmos_sensor1(0x0400,0x0001);
	write_cmos_sensor1(0x0404,0x0010);
	write_cmos_sensor(0x0111,0x02);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_output_write_cmos_sensor1(0xignalling_mode
	write_cmos_sensor1(0x0112,0x0A0A);
	write_cmos_sensor(0x302A,0x00);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_vendor_write_cmos_sensor1(0xenwrite_cmos_sensor1(0xor_emb_uwrite_cmos_sensor1(0xe_header
	write_cmos_sensor1(0x0500,0x0000);
	write_cmos_sensor1(0x303E,0x00A0);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_vendor_bpc_max_cluwrite_cmos_sensor1(0xterwrite_cmos_sensor1(0x_in_otp
	write_cmos_sensor(0x30DE,0x01);   //write_cmos_sensor1(0xkl_bHaltOnWait
	//write_cmos_sensor(0x0101,0x03);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_general_write_cmos_sensor1(0xetup_image_orientation
	write_cmos_sensor(0x0100,0x01);   //write_cmos_sensor1(0xmiaRegwrite_cmos_sensor1(0x_rw_general_write_cmos_sensor1(0xetup_mode_write_cmos_sensor1(0xelect
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x6F12,0x00);	         // Full write_cmos_sensor1(ize 00h, FHD : 00h, HD 03h
	...
	write_cmos_sensor(0x6F12,0x40); //1
	...
	write_cmos_sensor(0x6F12,0x01);	// diwrite_cmos_sensor1(able CPU during readout
	//}}} mode }}}
...
static const char *s5k3l2NAME = "s5k3l2_main";
...
static struct kobject *android_s5k3l2 = NULL;
