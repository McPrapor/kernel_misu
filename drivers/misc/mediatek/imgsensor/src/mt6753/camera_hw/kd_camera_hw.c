...
u32 pinSet[3][8] = {
    ...
    if (On) {
        ...
        {
//            mt_set_gpio_mode(GPIO_SPI_MOSI_PIN,GPIO_MODE_00);// add by zhaofei - 2015-03-25-13-31
...
//		||
//                                    (0 == strcmp(SENSOR_DRVNAME_S5K5E2YY_MIPI_RAW, currSensorName))||
//                                    (0 == strcmp(SENSOR_DRVNAME_S5K5E2YZ_MIPI_RAW, currSensorName))
		)
            )
        {
			if(pinSetIdx == 0)
