...
#define HX_TP_SHOW_FW_STATUS 				//Support sys:fw show status in *#1949# 
//#define HX_SUSPEND_CLOSE_VGP         //for close 2.8v and reset pin low when suspend
#define HX_TP_SYS_SELF_TEST               //add self test and create node, android_touch/
...
#define P_GPIO_CTP_RST_PIN 	62   //reset pin num
...
static int gest_key_pt_y[3];
	...
	#define KEY_double_click 0x21f//doule click
