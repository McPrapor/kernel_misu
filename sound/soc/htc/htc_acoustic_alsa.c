...
// For effect icon ++
static ssize_t effect_icon_print_name(struct switch_dev *sdev, char *buf)
{
	return sprintf(buf, "effect_icon\n");
}
// For effect icon --
...
// For effect icon ++
	...
	sdev_effect_icon.print_name = effect_icon_print_name;
